 ...
 */
export function renderReviewInboxLine(ctx) {
...
function formatInboxItem(colors) {
    return (item) => `${item.author} ${projectColor(`#${item.number}`, colors)}`;
}
//# sourceMappingURL=review-inbox.js.map